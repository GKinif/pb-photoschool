 ...
 */
export function subscribeToCollection<T>(collection: string, limit = 100, startWith: any[] = []) {
	console.log('subscribeToCollection: ', collection, limit, startWith);
