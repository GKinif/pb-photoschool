...
<section>
	<div class="relative isolate overflow-hidden bg-gray-900 py-24 px-6 sm:py-32 lg:px-8 rounded-lg mb-16">
		<img src="https://placekitten.com/800/300" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover">
		<div class="mx-auto max-w-2xl text-center">
			<h1 class="text-4xl font-bold tracking-tight text-primary-100 sm:text-6xl">Photography School</h1>
			<p class="mt-6 text-lg leading-8 text-primary-300">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
		</div>
	</div>
	...
	<div class="container mx-auto flex flex-col bg-primary-900 py-16 sm:py-24 px-8 rounded-lg mb-16">
		...
		<div class="flex flex-col sm:flex-row justify-center sm:divide-x-2 sm:divide-primary-100">
			<div class="flex flex-col items-center flex-1 py-4 px-6">
				<h3 class="rounded-full border-2 border-primary-100 h-12 w-12 flex items-center justify-center mb-4 text-lg font-semibold text-primary-100">1</h3>
				<p class="text-center text-primary-100 text-lg">Learn with a world class teacher</p>
			</div>
			<div class="flex flex-col items-center flex-1 py-4 px-6">
				<h3 class="rounded-full border-2 border-primary-100 h-12 w-12 flex items-center justify-center mb-4 text-lg font-semibold text-primary-100">2</h3>
				<p class="text-center text-primary-100 text-lg">Evolve with our different programs</p>
			</div>
			<div class="flex flex-col items-center flex-1 py-4 px-6">
				<h3 class="rounded-full border-2 border-primary-100 h-12 w-12 flex items-center justify-center mb-4 text-lg font-semibold text-primary-100">3</h3>
				<p class="text-center text-primary-100 text-lg">Quality classes for a fraction of the cost of traditional schools</p>
			</div>
		</div>
	</div>
	...
	<ul class="divide-y divide-gray-200">
		{#await levelsPromise}
			<li class="flex py-8 px-12 animate-pulse">
				<div
						class="w-96 h-60 bg-slate-200 rounded"
				></div>
		...
		{:then levels}
			...
			{/each}
		{:catch error}
			<p class="text-center font-semibold text-error-600 border border-error-600 rounded p-4">{error.message}</p>
		{/await}
	</ul>
		...
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			<div class="mx-auto max-w-2xl lg:max-w-none">
				<div class="text-center">
					<h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Trusted by studends for more than 10 years</h2>
					<p class="mt-4 text-lg leading-8 text-primary-300">Lorem ipsum dolor sit amet consect adipisicing possimus.</p>
				</div>
				<dl class="mt-16 grid grid-cols-1 gap-0.5 overflow-hidden rounded-2xl text-center sm:grid-cols-2 lg:grid-cols-4">
					...
					<div class="flex flex-col bg-white/5 p-8">
						...
						<dd class="order-first text-3xl font-semibold tracking-tight text-primary-100">Starting at 400€</dd>
					</div>
					...
					<div class="flex flex-col bg-white/5 p-8">
						...
						<dd class="order-first text-3xl font-semibold tracking-tight text-primary-100">2 / Years</dd>
					</div>
				</dl>
			</div>
		</div>
